    ...
    urlCollection.forEach((baseUrl) =>
      it.each([
        ...
        },
        {
          url:
            baseUrl +
            "q=poewiki+faster+attacks&rlz=1CDSA2EA_enUS653US116&oq=poe+test+wiki&aqs=chrome..6213i57j64.1j7&sourceid=chrome&ie=UTF-8",
          expected: redirectBaseUrl + "faster+attacks",
        },
        {
        ...
        // Making sure words that happen to contain "poe", "wiki" or "poewiki" do not get filtered
        {
          url:
            baseUrl +
            "q=poe+apoe+poea+apoea+awiki+wikia+awikia+wiki+apoewiki+poewikia+apoewikia+poeawiki",
          expected:
            redirectBaseUrl +
            "apoe+poea+apoea+awiki+wikia+awikia+apoewiki+poewikia+apoewikia+poeawiki",
        },
      ])(
